...
# Examples:
#
# .\ImportSCAPBaseline_Windows10.ps1 -ImportType Classified
# .\ImportSCAPBaseline_Windows10.ps1 -ImportType Public
# .\ImportSCAPBaseline_Windows10.ps1 -ImportType Sensitive
# .\ImportSCAPBaseline_Windows10.ps1 -ImportType CAT1
# .\ImportSCAPBaseline_Windows10.ps1 -ImportTYpe SlowRules
#
###########################################################
...
(
    ...
    [string]$FileDirectory1="E:\Source\SCAP2DCM\WIN10\Classified",
    [string]$Parse_Results1="New-Object System.Collections.ArrayList",
    [string]$FileDirectory2="E:\Source\SCAP2DCM\WIN10\Public",
    [string]$Parse_Results2="New-Object System.Collections.ArrayList",
    [string]$FileDirectory3="E:\Source\SCAP2DCM\WIN10\Sensitive",
    [string]$Parse_Results3="New-Object System.Collections.ArrayList",
    [string]$FileDirectory4="E:\Source\SCAP2DCM\WIN10\CAT1",
    [string]$Parse_Results4="New-Object System.Collections.ArrayList",
    [string]$FileDirectory5="E:\Source\SCAP2DCM\WIN10\SlowRules",
...
if ($ImportType -like "Classified") 
{
    Import-Classified
    Write-Host ""
    Write-Host -ForegroundColor Green "Windows 10 Classified SCAP Baselines and Configuration Items imported successfully."
}
elseif ($ImportType -like "Public") 
{
    Import-Public
    Write-Host ""
    Write-Host -ForegroundColor Green "Windows 10 Public SCAP Baselines and Configuration Items imported successfully"
}
elseif ($ImportType -like "Sensitive") 
{
    Import-Sensitive
    Write-Host ""
    Write-Host -ForegroundColor Green "Windows 10 Sensitive SCAP Baselines and Configuration Items imported successfully"
}
elseif ($ImportType -like "CAT1") 
{
    Import-CAT1
    Write-Host ""
    Write-Host -ForegroundColor Green "Windows 10 CAT1 SCAP Baselines and Configuration Items imported successfully"
}
elseif ($ImportType -like "SlowRules") 
{
    Import-SlowRules
    Write-Host ""
    Write-Host -ForegroundColor Green "Windows 10 Slow Rules SCAP Baselines and Configuration Items imported successfully"
}
