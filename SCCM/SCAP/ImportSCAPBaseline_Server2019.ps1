...
# Examples:
# 
# .\ImportSCAPBaseline_Server2019.ps1 -ImportType Classified
# .\ImportSCAPBaseline_Server2019.ps1 -ImportType Public
# .\ImportSCAPBaseline_Server2019.ps1 -ImportType Sensitive
# .\ImportSCAPBaseline_Server2019.ps1 -ImportType CAT1
# .\ImportSCAPBaseline_Server2019.ps1 -ImportTYpe SlowRules
# 
#################################################
...
(
    ...
    [string]$FileDirectory1="E:\Source\SCAP2DCM\Srever2019\Classified",
    [string]$Parse_Results1="New-Object System.Collections.ArrayList",
    [string]$FileDirectory2="E:\Source\SCAP2DCM\Server2019\Public",
    [string]$Parse_Results2="New-Object System.Collections.ArrayList",
    [string]$FileDirectory3="E:\Source\SCAP2DCM\Server2019\Sensitive",
    [string]$Parse_Results3="New-Object System.Collections.ArrayList",
    [string]$FileDirectory4="E:\Source\SCAP2DCM\Server2019\CAT1",
    [string]$Parse_Results4="New-Object System.Collections.ArrayList",
    [string]$FileDirectory5="E:\Source\SCAP2DCM\Server2019\SlowRules",
