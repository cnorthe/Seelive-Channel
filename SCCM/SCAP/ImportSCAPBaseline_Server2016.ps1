...
# Examples:
# 
# .\ImportSCAPBaseline_Server2016.ps1 -ImportType Classified
# .\ImportSCAPBaseline_Server2016.ps1 -ImportType Public
# .\ImportSCAPBaseline_Server2016.ps1 -ImportType Sensitive
# .\ImportSCAPBaseline_Server2016.ps1 -ImportType CAT1
# .\ImportSCAPBaseline_Server2016.ps1 -ImportTYpe SlowRules
# 
############################################################
...
(
    ...
    [string]$FileDirectory1="E:\Source\SCAP2DCM\Server2016\Classified",
    [string]$Parse_Results1="New-Object System.Collections.ArrayList",
    [string]$FileDirectory2="E:\Source\SCAP2DCM\Server2016\Public",
    [string]$Parse_Results2="New-Object System.Collections.ArrayList",
    [string]$FileDirectory3="E:\Source\SCAP2DCM\Server2016\Sensitive",
    [string]$Parse_Results3="New-Object System.Collections.ArrayList",
    [string]$FileDirectory4="E:\Source\SCAP2DCM\Server2016\CAT1",
    [string]$Parse_Results4="New-Object System.Collections.ArrayList",
    [string]$FileDirectory5="E:\Source\SCAP2DCM\Server2016\SlowRules",
...
if ($ImportType -like "Classified") 
{
    Import-Classified
    Write-Host ""
    Write-Host -ForegroundColor Green "Server 2016 Classified SCAP Baselines and Configuration Items imported successfully."
}
elseif ($ImportType -like "Public") 
{
    Import-Public
    Write-Host ""
    Write-Host -ForegroundColor Green "Server 2016 Public SCAP Baselines and Configuration Items imported successfully"
}
elseif ($ImportType -like "Sensitive") 
{
    Import-Sensitive
    Write-Host ""
    Write-Host -ForegroundColor Green "Server 2016 Sensitive SCAP Baselines and Configuration Items imported successfully"
}
elseif ($ImportType -like "CAT1") 
{
    Install-PreInstallCMComponentServer
    Write-Host ""
    Write-Host -ForegroundColor Green "Server 2016 CAT1 SCAP Baselines and Configuration Items imported successfully"
}
elseif ($ImportType -like "SlowRules") 
{
    Install-PreInstallCMComponentServer
    Write-Host ""
    Write-Host -ForegroundColor Green "Server 2016 Slow Rules SCAP Baselines and Configuration Items imported successfully"
}
