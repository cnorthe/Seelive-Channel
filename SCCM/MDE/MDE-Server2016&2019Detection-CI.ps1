...
#Script created by Clive Northey (Microsoft Consultant Services) 9/28/2022
...
elseif ($server2016) {
    ...
    if ($defenderFeature.Installed -eq $true -and $defender.Installed -eq $true -and $defenderGUI.Installed -eq $true)
    { #Defender Features installed
        return $true
    }
    else
